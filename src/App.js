...
export default class App extends Component {
  ...
  getFilteredProjects=()=>{
    ...
    const filteredProjects = projectsList.filter((each)=>
   ...
   return (
    <div className="App-container">
      ...
      <div className='time-description-container'>
        ...
        <p className='description-main'>Your skills and achievements showcase your strengths and abilities, Speak about any new skills of software you learnt to performs the project responsibilities</p>
      </div>
